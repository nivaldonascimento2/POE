...
//329353/1341606/2.50/2/2/Capacitor Polarised
...
(library Library_1
	...
	(symbolDef "EEE-FK1J100P" (originalName "EEE-FK1J100P")
	...
	(compDef "EEE-FK1J100P" (originalName "EEE-FK1J100P") (compHeader (numPins 2) (numParts 1) (refDesPrefix C)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "EEE-FK1J100P"))
		...
		(attr "Mouser Part Number" "667-EEE-FK1J100P")
		(attr "Mouser Price/Stock" "https://www.mouser.com/Search/Refine.aspx?Keyword=667-EEE-FK1J100P")
		(attr "Manufacturer_Name" "Panasonic")
		(attr "Manufacturer_Part_Number" "EEE-FK1J100P")
		(attr "Description" "Aluminum Electrolytic Capacitors - SMD 10uF 63V")
		(attr "<Hyperlink>" "https://componentsearchengine.com/Datasheets/1/EEE-FK1J100P.pdf")
		(attr "<Component Height>" "7.8")
		(attr "<STEP Filename>" "EEE-FK1J100P.stp")
