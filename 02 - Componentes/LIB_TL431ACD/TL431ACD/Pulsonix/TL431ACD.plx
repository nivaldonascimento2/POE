...
(library Library_1
	...
	(compDef "TL431ACD" (originalName "TL431ACD") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		...
		(compPin "8" (pinName "REF") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "7" (pinName "ANODE_4") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "6" (pinName "ANODE_3") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attr "<Hyperlink>" "https://www.ti.com/lit/ds/symlink/tl431.pdf?HQS=TI-null-null-mousermode-df-pf-null-wwe&ts=1593427466636&ref_url=https%253A%252F%252Fwww.mouser.in%252F")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "TL431ACD.stp")
