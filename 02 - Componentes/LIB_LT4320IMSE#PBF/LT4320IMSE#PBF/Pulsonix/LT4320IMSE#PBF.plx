...
(library Library_1
	...
	(symbolDef "LT4320IMSE#PBF" (originalName "LT4320IMSE#PBF")
	...
	(compDef "LT4320IMSE#PBF" (originalName "LT4320IMSE#PBF") (compHeader (numPins 12) (numParts 1) (refDesPrefix IC)
		...
		(compPin "1" (pinName "IN2") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Input))
		...
		(compPin "12" (pinName "IN1") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Input))
		(compPin "11" (pinName "TG1") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "10" (pinName "NC_4") (partNum 1) (symPinNum 9) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "9" (pinName "OUTP") (partNum 1) (symPinNum 10) (gateEq 0) (pinEq 0) (pinType Output))
		(compPin "8" (pinName "NC_3") (partNum 1) (symPinNum 11) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "7" (pinName "OUTN") (partNum 1) (symPinNum 12) (gateEq 0) (pinEq 0) (pinType Output))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "LT4320IMSE#PBF"))
		...
		(attr "<Hyperlink>" "https://datasheet.datasheetarchive.com/originals/distributors/Datasheets_SAMA/f9c8f44be51ba9be14d0fe4fedec3709.pdf")
		(attr "<Component Height>" "1.1")
		(attr "<STEP Filename>" "LT4320IMSE#PBF.stp")
